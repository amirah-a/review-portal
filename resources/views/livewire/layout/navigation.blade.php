...
<nav x-data="{ open: false, dropdownOpen: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                {{-- Hide applications from coordinator --}}
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="{{ $this->dashboardRoute() }}" wire:navigate
                class="block w-full ps-3 pr-4 py-2 border-l-4 text-base font-medium transition duration-150 ease-in-out">
